    ...
    if (type === 'student') {
        return (
            <ul className='lk__nav lk__nav_student'>
                <li className={active === 1 ? 'lk__nav_li active' : 'lk__nav_li'}>
                    <IconRenderer id={'person'} />
                    <p className='lk__nav_text'>Аккаунт</p>
                </li>
                <li className={active === 2 ? 'lk__nav_li active' : 'lk__nav_li'}>
                    <IconRenderer id={'key'} />
                    <p className='lk__nav_text'>Личные данные</p>
                </li>
                <li className={active === 3 ? 'lk__nav_li active' : 'lk__nav_li'}>
                    <IconRenderer id={'book'} />
                    <p className='lk__nav_text'>Мои уроки</p>
                </li>
                <li className={active === 4 ? 'lk__nav_li active' : 'lk__nav_li'}>
                ...
                <li className={active === 6 ? 'lk__nav_li active' : 'lk__nav_li'}>
                    <IconRenderer id={'statistic'} />
                    <p className='lk__nav_text'>Статистика</p>
                </li>
                <li className={active === 7 ? 'lk__nav_li active' : 'lk__nav_li'}>
