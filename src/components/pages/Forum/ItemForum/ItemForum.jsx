...
const ItemForum = ({
    ...
    return (
        <div className={`item-forum ${head ? 'item-forum_head' : ''} ${topic ? 'item-forum_topic' : ''}`}>
            {head ? (
                <p className='item-forum__title'>{title}</p>
            ) : (
                <div className='item-forum__name'>
                    <div className='item-forum__icon-wrap'>
                        <img className='item-forum__icon' src={icon} alt='icon' />
                    </div>
                    ...
                    <div className='item-forum__name-topic'>
                        ...
                        {author ? (
                            <p className='item-forum__author'>
                                от <Link className='item-forum__author-link'>{author}</Link>
                            </p>
                        ) : (
                            <></>
                        )}
            ...
            <div className='item-forum__info'>
                <div className='item-forum__info-wrap'>
                    ...
                    <div className='item-forum__update'>
                        ...
                        {topic && !head ? (
                            <p className='item-forum__author'>
                                от <Link className='item-forum__author-link'>{lastAuthor}</Link>
                            </p>
                        ) : (
                            <></>
                        )}
