                    ...
                    <div className='article__ul-wr'>
                        <ol className='article__ul'>
                            ...
                            <li className='article__li'>
                                ...
                                <ul className='article__ol'>
                                    <li className='article__li'>
                                        cайт рыбатекст поможет дизайнеру, верстальщику, вебмастеру
                                    </li>
                                    <li className='article__li'>
                                        сгенерировать несколько абзацев более менее осмысленного
                                        текста рыбы на русском языке,при создании генератора мы
                                    </li>
                                    <li className='article__li'>
                        ...
                        <div className='article__bottom-text-wr'>
                            <p>
                                По своей сути рыбатекст является альтернативой традиционному lorem
                                ipsum, который вызывает у некторых людей недоумение при попытках
                                прочитать рыбу текст. Сайт рыбатекст поможет дизайнеру, верстальщику
                            </p>
                            <p>
                                В отличии от lorem ipsum, текст рыба на русском языке наполнит любой
                                макет непонятным смыслом и придаст неповторимый колорит советских
                                времен.
                            </p>
                            <p>
                                Сайт рыбатекст поможет дизайнеру, верстальщику, вебмастеру
